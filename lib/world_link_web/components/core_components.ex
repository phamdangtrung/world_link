defmodule WorldLinkWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WorldLinkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WorldLinkWeb.Gettext, "errors", msg, opts)
    end
  end
