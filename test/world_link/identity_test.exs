defmodule WorldLink.IdentityTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.activated_at == ~U[2023-02-28 09:51:00Z]
      assert user.approved == true
      assert user.auth_token == "some auth_token"
      assert user.auth_token_expires_at == ~U[2023-02-28 09:51:00Z]
      assert user.discord_handle == "some discord_handle"
      ...
      assert user.joined_at == ~U[2023-02-28 09:51:00Z]
      assert user.name == "some name"
      assert user.signed_in_at == ~U[2023-02-28 09:51:00Z]
