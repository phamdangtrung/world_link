defmodule WorldLink.WorldsTest do
  ...
  describe "assign_characters_to_a_world/2" do
    ...
    test "should successfully assign all given characters to a world", %{
      regular_user: regular_user
    } do
    ...
    test "should return {:error, :empty_list} when given a list with no item", %{
      regular_user: regular_user
    } do
      world = WorldsFactory.build(:world, user: regular_user) |> WorldsFactory.insert()
  ...
  describe "assign_a_character_to_a_world/2" do
    ...
    test "should return {:error, %Ecto.Changeset{}} when re-assign a character", %{
      regular_user: regular_user
    } do
      character = WorldsFactory.build(:character, user: regular_user) |> WorldsFactory.insert()
      world = WorldsFactory.build(:world, user: regular_user) |> WorldsFactory.insert()
    ...
    test "should return {:error, :invalid_params} when given invalid parameters", %{
